...
h2.cmd('sysctl -w net.ipv4.tcp_max_syn_backlog=10000')
h2.cmd('sysctl -w net.ipv4.tcp_syncookies=0')
h2.cmd('sysctl -w net.ipv4.tcp_synack_retries=1')

h1.cmd(f'tcpdump -w Q2_attack_copy.pcap -i {h1.defaultIntf()} tcp &')
time.sleep(1)
